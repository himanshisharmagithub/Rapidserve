    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-2xl bg-slate-900/80 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-2xl p-8">
        ...
        <div className="mt-8 space-y-4">
          <textarea
            className="w-full bg-slate-800 border border-slate-600 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-4 bg-indigo-600 hover:bg-indigo-700 transition rounded-lg py-3 font-semibold disabled:opacity-50"
          >
